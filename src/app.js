document.addEventListener('alpine:init', () => {
  ...
  Alpine.data('products', () => ({
    items: [
      { id: 1, name: 'Bakso Biasa', img: 'img/product/tentang-kami1.jpg', price: 10000, desc: 'Bakso daging sapi asli dengan kuah gurih dan mi.' },
      { id: 2, name: 'Bakso Spesial', img: 'img/product/tentang-kami2.jpg', price: 15000, desc: 'Bakso urat jumbo ditambah bakso halus dan tahu.' },
